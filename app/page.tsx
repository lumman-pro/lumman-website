...
export const metadata: Metadata = {
  description:
    "AI R&D Lab helping companies automate operations and evolve using AI. From signal to system. Cognition. In motion. Expert AI agents, automations, and advisory services.",
  keywords: [
    "AI automation",
